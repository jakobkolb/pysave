...
if __name__ == '__main__':
    ...
    input_parameters = {'tau': 1000, 'phi': 0., 'eps': 0.0, 'b': 1., 'P': 1.}
    ...
    trajectory[['s', 'r', 'wage']].plot(ax=ax1, style=colors)

    ax2 = fig.add_subplot(223)
    nx.draw(g, ax=ax2, cmap=plt.get_cmap('jet'), node_color=model.savings_rate, node_size=40)
